...
function MobileMenu() {
  ...
  const openMenuStyle =
    "bg-neutral-950 fixed top-0 bottom-0 left-0 w-[55%] border-r border-green-500/30 p-2 duration-300 ease-in";
  const closeMenuStyle =
    "bg-neutral-950 fixed top-0 bottom-0 left-[-500px] w-[55%] border-r border-green-500/30 p-2 duration-300 ease-in";
